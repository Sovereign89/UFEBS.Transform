...
{
  public class AcknowledgementInfo11 : Header
  {
    ...
    {
      get => new CBR.UfebsStream.QName("AcknowledgementInfo", "urn:cbr-ru:msg:props:v1.1");
    }

    public AcknowledgementInfo11()
    {
    ...
    public AcknowledgementInfo11(int acknowledgementType, string resultCode, string resultText)
    {
    ...
    {
      return (object) new AcknowledgementInfo11(this.acknowledgementType, this.resultCode, this.resultText);
    }
