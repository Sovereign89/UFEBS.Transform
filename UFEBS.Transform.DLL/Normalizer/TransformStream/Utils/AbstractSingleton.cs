    ...
    public class AbstractSingleton<T>
    {
        ...
        public static T GetInstance()
        {
            if ((object)AbstractSingleton<T>.instance == null)
            {
                ...
                AbstractSingleton<T>.instance = !(constructor == (ConstructorInfo)null) ? (T)constructor.Invoke(new object[0]) : throw new ApplicationException(string.Format("Тип {0} не имеет закрытого конструктора без параметров", (object)typeof(T).FullName));
            }
